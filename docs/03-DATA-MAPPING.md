...
`Item Code` (เฉพาะ 10 รหัสที่กำหนด — แสดงเป็น icon กลุ่ม + ชื่อย่อ),
...
| รหัสวัสดุ | `Item Code` | E | คอลัมน์ซ้าย — แสดงเป็น `icon · ชื่อย่อ` (ดู `TARGET_ITEMS`) |
...
| สถานะ | `Status` | AA | สี + น้ำหนักตัวอักษรของ icon ในแถว |
...
แถวข้อมูลแสดงเป็น **`icon · short`** แทน Item Code เต็ม

| icon | Item Code | ชื่อย่อบนการ์ด | ชื่อวัสดุเต็ม (เก็บไว้อ้างอิง) |
|---|---|---|---|
