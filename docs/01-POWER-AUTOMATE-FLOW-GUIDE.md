...
### 5.4 ส่งทั้ง MA และ Optimize ในสัปดาห์เดียว

เพิ่ม **Run script** + **Post adaptive card** อีกคู่หนึ่ง
โดยคู่ที่สองใส่ `period` = `Optimize(3 Aug 26)` (หรือรอบ Optimize ล่าสุด)
