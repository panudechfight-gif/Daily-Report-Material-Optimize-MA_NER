...
ลด `topRows` ใน action `Run script` เหลือ `8`

**ขนาดจริงที่วัดจากข้อมูลในไฟล์นี้**

| แถว | ชุด MA (4 Zone) | ชุด Optimize (5 Zone) |
|---|---|---|
| 8 | 20.6 KB | 22.5 KB |
| 9 | 21.9 KB | 23.8 KB |
| 10 | 23.2 KB ✅ | 25.0 KB ✅ |
...
หัวกลุ่ม Zone แต่ละชุดกินที่คงที่ราว 1.5 KB — รอบที่มี Zone มากจึงเหลือที่ให้แถวน้อยกว่า
