...
ปกติ **ไม่ต้องทำอะไร** — สคริปต์วัดขนาดการ์ดเองแล้วลดแถวให้อัตโนมัติ
ถ้าเกินงบ 26,000 ไบต์ (ดู `CARD_SAFE_BYTES` ใน `renderAdaptiveCard.ts`)

ถ้ายังเจอปัญหา แปลว่ากำลังใช้สคริปต์เวอร์ชันเก่าที่ยังไม่มีตัววัดขนาด
ให้คัดลอก `office-scripts/renderAdaptiveCard.ts` ตัวล่าสุดไปวางทับใน Excel

**ขนาดจริงที่วัดจากข้อมูลในไฟล์นี้ (หลังรวมแถวซ้ำแล้ว)**

| รอบ | แถวบนการ์ด | ขนาด |
|---|---|---|
| Optimize (3 Aug 26) — 5 Zone | 35 (ครบทั้งรอบ) | 24.9 KB ✅ |
| MA (17 Aug 26) — 4 Zone | 24 (ครบทั้งรอบ) | 19.4 KB ✅ |
| MA (10 Aug 26) — 3 Zone | 7 (ครบทั้งรอบ) | 10.1 KB ✅ |

การ์ดรวมแถวซ้ำให้แล้ว (1 Zone + 1 Item Code = 1 แถว) ทั้งรอบจึงลงการ์ดใบเดียวได้หมด
เช่น MA (17 Aug 26) มี 74 แถวดิบ เหลือ 24 แถวหลังรวม
