...
| ☐ | D11. `topRows` = `50` | สคริปต์วัดขนาดการ์ดแล้วลดแถวให้เองถ้าจำเป็น |
...
| ☐ | E3. หัวการ์ดเขียนว่า 🏬 `Report Stock Allocation Cable&Material NER` | 🏬 เป็น emoji ตัวเดียวในการ์ดทั้งใบ |
| ☐ | E3b. ป้ายชุดข้อมูลถูกต้อง | `MA — Weekly Allocation` (ฟ้า) / `Optimize — Allocation Plan` (เขียว) — หัวการ์ดใช้ 🏬 ทั้งคู่ |
| ☐ | E4. แถบบนแสดง รอบจัดสรร / รอบก่อนหน้า / ชุดข้อมูล ครบ | ค่าไม่เป็น `-` ทั้งหมด |
| ☐ | E5. กล่องตัวเลข 4 กล่องแสดงถูก | เสี่ยงขาด + พอใช้ + ปกติ = รวม |
| ☐ | E6. **หัวกลุ่มขึ้นครบทุก Zone** ที่รอบนั้นมี | RC2-NMA · RC2-UBN · RC3-KKN · RC3-UDN · RC3-SNK (ตัวหนา ไม่มี emoji) |
| ☐ | E7. แถวข้อมูล 2 คอลัมน์ และ **ไม่มีชื่อ Province** | ซ้าย: ชื่อย่อ (ไม่มี emoji) ขวา: `Onhand · กระจาย · Hub` รวมบรรทัดเดียว |
| ☐ | E7b. ตัวเลข **เบิก Hub เป็นจำนวนเต็ม** | ไม่มีจุดทศนิยมสักแถว |
...
| ☐ | E16. แถวที่รวมหลายจังหวัดมีป้ายต่อท้ายชื่อย่อ | เช่น `ARSS Fiber Cable 12C ·3จว.` |
| ☐ | E17. หัวกลุ่ม Zone แสดงยอดรวมทั้งโซน | เช่น `RC2-NMA · 9 รายการ · Onhand 42,749 · กระจาย … · เบิก Hub 0` |
| ☐ | E18. **ค่า "เบิก Hub" ตรงกับชีต** | เปิดชีต บวก 3 ช่องซ้ายของ `รวม 3 รายการ` ต้องได้เท่าค่าในช่องนั้น (ดู [ข้อ 7.1](04-TROUBLESHOOTING.md)) |
| ☐ | E19. ตารางอธิบายอยู่ท้ายการ์ด ครบ 4 กลุ่ม | NAME PLATE / CLOSURE / DROP CABLE / ARSS FIBER CABLE |
