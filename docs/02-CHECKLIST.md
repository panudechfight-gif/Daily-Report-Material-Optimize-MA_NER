...
| ☐ | E7. ตารางครบ 5 คอลัมน์ และ **ไม่มีชื่อ Province** | Item Code / Onhand / เบิก Hub / Prev_Before / Prev_Recv |
...
| ☐ | E18. **ค่า "เบิกจาก Hub" ตรงกับชีต** | เปิดชีต บวก 3 ช่องซ้ายของ `รวม 3 รายการ` ต้องได้เท่าค่าในช่องนั้น (ดู [ข้อ 7.1](04-TROUBLESHOOTING.md)) |
| ☐ | E19. ตารางอธิบายรหัสวัสดุอยู่ท้ายการ์ด | 8 รหัสพร้อมชื่อเต็ม |
