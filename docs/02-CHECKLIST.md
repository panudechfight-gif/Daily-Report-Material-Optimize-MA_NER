...
| ☐ | D10b. `period` = `-` | **ห้ามเว้นว่าง** — ถ้าว่างจะขึ้น `'ScriptParameters/period' is required` |
| ☐ | D11. `topRows` = `10` | **ห้ามเกิน 10** (หัวกลุ่ม Zone กินที่ ~1.5 KB ต่อโซน) |
...
| ☐ | E3. หัวการ์ดเขียนว่า `Report Material Optimize&MA_NER` | ไม่ใช่ชื่อเดิม |
...
| ☐ | E7. ตารางครบ 5 คอลัมน์ และ **ไม่มี Province** | Item Code / OMC-Onhand / เบิกจาก Hub / Prev_Before / Prev_Received |
| ☐ | E7b. คอลัมน์ **เบิกจาก Hub เป็นจำนวนเต็ม** | ไม่มีจุดทศนิยมสักแถว |
| ☐ | E8. รายการเสี่ยงขาดอยู่บนสุดของแต่ละ Zone และเป็นตัวหนา | ทดสอบด้วย `period` = `MA (10 Aug 26)` (มี 9 รายการเสี่ยง) |
| ☐ | E9. บรรทัด "…และอีก N รายการ" ขึ้นถูก | N = ยอดรวม − 10 |
...
| ☐ | E14. **คืนค่า `period` กลับเป็น `-` แล้ว** | ไม่ลืมข้อนี้! (ห้ามเว้นว่าง) |
