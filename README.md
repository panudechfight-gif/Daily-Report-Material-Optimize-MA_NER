...
แต่ละรหัสมี **icon นำหน้าในตาราง** บอกว่าของชิ้นนั้นคืออะไรตั้งแต่แรกเห็น

| icon | Item Code | ชื่อวัสดุ | คืออะไร |
|---|---|---|---|
| 🧵 | `53OF150BB` | OPTICAL FIBER DROP CABLE 1C, FLAT TYPE (G.657A) … | สาย Pigtail Patch สำหรับ Splice เชื่อมต่อ |
| 🧶 | `53OF157BB` | ARSS OPTICAL FIBER CABLE 12c-FIBRE3 | สาย Cable Fiber Optic |
| 🧶 | `53OF158BB` | ARSS OPTICAL FIBER CABLE 24c-FIBRE3 | สาย Cable Fiber Optic |
| 🧶 | `53OF160BB` | ARSS OPTICAL FIBER CABLE 60c-FIBRE3 | สาย Cable Fiber Optic |
| 🏷️ | `50MT004BB` | Name Plate (Aluminium) | ป้ายชื่อติดอุปกรณ์ |
| 🔗 | `52CL003BB` | CLOSURE 12 C | หัวต่อ CLOSURE สำหรับตัดต่อ Cable Optic |
| 🔗 | `52CL004BB` | CLOSURE 24 C | หัวต่อ CLOSURE สำหรับตัดต่อ Cable Optic |
| 🔗 | `52CL010BB` | CLOSURE 60 C | หัวต่อ CLOSURE สำหรับตัดต่อ Cable Optic |

ตารางอธิบายท้ายการ์ด **ยุบรหัสที่ใช้ icon เดียวกันไว้บรรทัดเดียว**
คำอธิบายจึงไม่ถูกพิมพ์ซ้ำ และเหลือที่ให้แถวข้อมูลจริงมากขึ้น
...
| Onhand | คอลัมน์ตาราง · รวมต่อ Zone บนหัวกลุ่ม |
| จัดสรร(กระจาย) | คอลัมน์ `กระจาย` — **ชุด Optimize ลงยอดไว้ที่นี่** |
| จัดสรร(เบิก Hub) | คอลัมน์ `เบิก Hub` — **ชุด MA ลงยอดไว้ที่นี่** — จำนวนเต็ม |
...
การ์ดถูกทำให้เล็กลงด้วยการตัดคอลัมน์ `Prev_Before` / `Prev_Received` ออก
ทุกรอบจึงลงการ์ดใบเดียว **ครบทุกรหัส ไม่มีการตัดแถวทิ้ง**:

| รอบ | Zone | แถวดิบ | แถวบนการ์ด | UTF-8 | worst case |
|---|---|---|---|---|---|
| Optimize (3 Aug 26) | 5 | 35 | **35 ครบ** | 21.4 KB | 23.0 KB ✅ |
| MA (17 Aug 26) | 4 | 74 | **24 ครบ** | 16.8 KB | 18.3 KB ✅ |
| MA (10 Aug 26) | 3 | 10 | **7 ครบ** | 8.5 KB | 9.1 KB ✅ |
