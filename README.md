...
แถวข้อมูลบนการ์ดแสดง **ชื่อย่อ** แทน Item Code เต็ม
...
> การ์ดหลัก **ไม่แสดง emoji ในแถวข้อมูล** — มี emoji ตัวเดียวคือ 🏬 ที่หัวการ์ด
> คอลัมน์ `icon` ข้างล่างยังคำนวณไว้ให้การ์ดใบอื่นใช้ (`02_` / `04_`)

| icon (`itemIcon`) | Item Code | ชื่อวัสดุเต็ม | ชื่อย่อบนการ์ด |
|---|---|---|---|
...
**สี่กลุ่ม** — NAME PLATE · CLOSURE · DROP CABLE · ARSS FIBER CABLE
ตารางอธิบายท้ายการ์ดแบ่งตามกลุ่มนี้ (ชื่อกลุ่มล้วน ไม่มี icon นำหน้าบนการ์ดหลัก)
...
| ข้อมูล | ที่มา |
|---|---|
| ชุดข้อมูล (Data_Set) | กำหนดสีของทั้งการ์ด — MA ฟ้า / Optimize เขียว (หัวการ์ดใช้ 🏬 ทั้งคู่ เป็น emoji ตัวเดียวในการ์ด) |
...
| Item Code | 10 รหัสตามตารางข้างบน — แสดงเป็นชื่อย่อ ไม่มี emoji |
...
| Status / Risk_Flag | สีและตัวหนาของชื่อย่อ + การเรียงลำดับแถว + กล่องสรุป 4 ช่อง |
...
|---|---|---|---|---|---|
| Optimize (3 Aug 26) | 5 | **45 ครบ** | 18.5 KB | 20.8 KB ✅ | 7.2 KB |
| MA (17 Aug 26) | 4 | **29 ครบ** | 14.4 KB | 16.3 KB ✅ | 11.7 KB |
| MA (10 Aug 26) | 3 | **9 ครบ** | 8.1 KB | 9.2 KB ✅ | 18.8 KB |
